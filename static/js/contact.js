// Gets the theme button from contact.html so JavaScript can control it
const themeToggleButton = document.getElementById('theme-toggle');

// Changes the Contact page theme and updates the theme button
function applyTheme(selectedTheme) {
  ...
  // Only updates the button if JavaScript found it in contact.html
...
// Applies the correct theme as soon as the Contact page loads
