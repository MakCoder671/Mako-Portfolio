// Gets the theme button from the HTML so JavaScript can control it
const themeToggleButton = document.getElementById('theme-toggle');

// Changes the page theme and updates the theme button
function applyTheme(selectedTheme) {
  // Adds the selected theme to the body so style.css knows which colors to use
  document.body.setAttribute('data-theme', selectedTheme);

  // Saves the theme in the browser so it stays the same after refreshing the page
  localStorage.setItem('theme', selectedTheme);

  // Only updates the button if JavaScript found it in the HTML
...
// Gets the theme that was saved during the visitor's last visit
...
// Applies the correct theme as soon as the page loads
